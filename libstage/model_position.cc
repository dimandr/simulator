...
ModelPosition::ModelPosition( World* world, 
  ...
  integration_error( drand() * INTEGRATION_ERROR_MAX_X - INTEGRATION_ERROR_MAX_X/2.0,
             drand() * INTEGRATION_ERROR_MAX_Y - INTEGRATION_ERROR_MAX_Y/2.0,
             drand() * INTEGRATION_ERROR_MAX_Z - INTEGRATION_ERROR_MAX_Z/2.0,
             qrand() * INTEGRATION_ERROR_MAX_A - INTEGRATION_ERROR_MAX_A/2.0 ),
  wheelbase( 1.0 ),
  acceleration_bounds(),
  velocity_bounds(),
  //public
